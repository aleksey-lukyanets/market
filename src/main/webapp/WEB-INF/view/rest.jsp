...
<pre style="width: 100%;">[<br>    {"id":9, "distillery": "Laphroaig", "name": "Quarter Cask"},<br>    {"id":1, "distillery": "Ardbeg", "name": "Ten"},<br>    {"id":31, "distillery": "Ardbeg", "name": "Uigeadail"},<br>    {"id":7, "distillery": "Caol Ila", "name": "12 y.o."},<br>    {"id":5, "distillery": "Glenkinchie", "name": "12 y.o."},<br>    {"id":8, "distillery": "Lagavulin", "name": "16 y.o."},<br>    {"id":6, "distillery": "Dalwhinnie", "name": "15 y.o."},<br>    {"id":4, "distillery": "Talisker", "name": "10 y.o."},<br>    {"id":3, "distillery": "Springbank", "name": "12 y.o. Cask Strength Batch 6"},<br>    {"id":10, "distillery": "Springbank", "name": "18 y.o."},<br>    {"id":2, "distillery": "Balvenie", "name": "12 y.o. Doublewood"}<br>]</pre>
<p>Сведения об отдельном товаре доступны по его идентификатору.
    Ресурс <code>/products/2</code>:</p>
<pre style="width: 45%;">{<br>    "id": 2,<br>    "distillery": "Balvenie",<br>    "name": "12 y.o. Doublewood",<br>    "price": 4100,<br>    "volume": 700,<br>    "alcohol": 40.0,<br>    "age": 12,<br>    "inStock": true<br>}</pre>
